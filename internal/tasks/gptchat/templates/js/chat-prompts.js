(function () {
  // https://github.com/rockbenben/ChatGPT-Shortcut/blob/e51121bb0567bca4b87bda8186dcccbbc5509ad0/src/data/users.tsx
  window.chatPrompts = [
    {
      title: '英语翻译或修改',
      description:
    ...
    },
    {
      ...
      remark: 'GitHub Copilot Chat Prompt',
      preview: null,
      website: null,
      source: null,
      tags: ['favorite', 'write'],
    },
    {
      ...
      remark:
        '先用第三方应用将语音转换成文字，再用 ChatGPT 进行处理。在进行语音录入时，通常会习惯性地说一些口头禅和语气词，使用 ChatGPT 就可以将其转换成书面语言，以优化语音转文字的效果。源于 @玉树芝兰老师的「用简洁的语言整理这一段话，要逻辑清晰，去掉错别字」。',
      preview: null,
      website: null,
      source: null,
      tags: ['favorite', 'write'],
